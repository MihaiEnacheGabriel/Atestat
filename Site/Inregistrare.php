    ...
    background: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url('bg3.jpg');
        ...
        <form action="register.php" method="post">
            ...
            <div class="container">
              ...
              <span class="psw" style="margin-right:39.8%">Aveți deja <a style="color:red;" href="Autentificare.php">cont?</a></span>
              <button type="submit" class="button">Inregistrare</button>
            </div>
          </form>
    </body>
</html>